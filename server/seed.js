...
const users = [
    { name: 'Admin User', email: 'admin@EVENTZ.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@EVENTZ.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@EVENTZ.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@EVENTZ.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@EVENTZ.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@EVENTZ.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@EVENTZ.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@EVENTZ.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@EVENTZ.com', password: 'password123', role: 'user' },
    { name: 'ayush', email: 'nitinpokhariya129@gmail.com', password: 'nitin20', role: 'admin' }
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/EVENTZ');
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@EVENTZ.com');
        console.log('User Email:  user@EVENTZ.com');
